...
describe('node - tag.elements() - function creation', function(){
...
describe('node - tag.elements() - DOM construction', function(){
...
describe('node - tag.elements() - Text node construction', function(){
...
describe('node - tag.elements() - Attributes', function(){
...
describe('node - tag.elements() - "class" attribute', function(){
...
/*
describe('node - tag.elements() - "innerHTML" attribute', function(){
...
describe('node - tag.elements() - "style" attribute', function(){
...
describe('node - tag.elements() - "data" attribute', function(){
...
describe('node - tag.elements() - other attribute', function(){
